...
const ProductForm = () => {
  ...
  const validate = () => {
    ...
    if (!name) customErrors.name = { name: 'name field is missing' }
    if (!description)
      customErrors.description = { description: 'description field is missing' }
    if (!price) customErrors.price = { price: 'price field is missing' }

    console.log(customErrors)

    const joiErrors = { ...joiObjErrors, ...joiArrErrors, ...customErrors }
    console.log('joiErrors', joiErrors)

    return setErrors(joiErrors)
  }
